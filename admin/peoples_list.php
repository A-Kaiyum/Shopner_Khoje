                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="page-header-title">
                                <h1 class="pull-left page-title">peoples</h1>
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-primary">
                                <div class="panel-heading">
                                    <h3 class="panel-title">List of peoples</h3>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                            <table id="datatable" class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php foreach($getpeoples as $key=>$people): ?>
                                                        <tr>
                                                            <td><?php echo $people['id']; ?></td>
                                                            <td><?php echo $people['name']; ?></td>
                                                            <td><?php echo $people['address']; ?></td>
                                                            <td><?php echo $people['phone']; ?></td>
                                                            <td><a href="update_people.php?id=<?= $people['id'];?>" class="btn btn-info btn-sm">Update</a>
                                                                <form  action="controller/PeopleController.php" method="post" style="display: inline-block;">
